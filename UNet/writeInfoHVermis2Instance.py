...
for path, dir_list, file_list in curFolder:
    for file_name in file_list:
        # Height of vermis
        if '_Height_of_vermis.json' in file_name:
            ...
            try:
                ...
                HVermis_1x, HVermis_1y = seg_info['Measurement']['mask1']
                HVermis_2x, HVermis_2y = seg_info['Measurement']['mask2']
                # print(key, HVermis_1x, HVermis_1y, HVermis_2x, HVermis_2y)
                if conn.update_instance_hvermis(key, HVermis_1x, HVermis_1y, HVermis_2x, HVermis_2y):
