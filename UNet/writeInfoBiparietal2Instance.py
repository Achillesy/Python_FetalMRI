...
for path, dir_list, file_list in curFolder:
    for file_name in file_list:
        ...
        if '_Biparietal_Diameter.json' in file_name:
            ...
            try:
                ...
                Biparietal_1x, Biparietal_1y = seg_info['Measurement']['mask1']
                Biparietal_2x, Biparietal_2y = seg_info['Measurement']['mask2']
                # print(key, Biparietal_1x, Biparietal_1y, Biparietal_2x, Biparietal_2y)
                if conn.update_instance_biparietal(key, Biparietal_1x, Biparietal_1y, Biparietal_2x, Biparietal_2y):
