...
for path, dir_list, file_list in curFolder:
    for file_name in file_list:
        # Cisterna Magna
        if '_Cisterna_Magna.json' in file_name:
            ...
            try:
                ...
                Cisterna_1x, Cisterna_1y = seg_info['Measurement']['mask1']
                Cisterna_2x, Cisterna_2y = seg_info['Measurement']['mask2']
                # print(key, Cisterna_1x, Cisterna_1y, Cisterna_2x, Cisterna_2y)
                if conn.update_instance_cisterna(key, Cisterna_1x, Cisterna_1y, Cisterna_2x, Cisterna_2y):
