...
for path, dir_list, file_list in curFolder:
    for file_name in file_list:
        ...
        if '_Cerebellar.json' in file_name:
            ...
            try:
                ...
                Cerebellar_1x, Cerebellar_1y = seg_info['Measurement']['mask1']
                Cerebellar_2x, Cerebellar_2y = seg_info['Measurement']['mask2']
                # print(key, Cerebellar_1x, Cerebellar_1y, Cerebellar_2x, Cerebellar_2y)
                if conn.update_instance_cerebellar(key, Cerebellar_1x, Cerebellar_1y, Cerebellar_2x, Cerebellar_2y):
